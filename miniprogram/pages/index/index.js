...
Page({
    data: {
        ...
        colourList: [{
            ...
            colour: 'bg-yellow.light'
        }, {
            colour: 'bg-olive.light'
        }, {
            colour: 'bg-green.light'
        }, {
            colour: 'bg-cyan.light'
        }, {
            colour: 'bg-blue.light'
        }, {
            colour: 'bg-purple.light'
        }, {
            colour: 'bg-mauve.light'
        }, {
            colour: 'bg-pink.light'
        }, {
            colour: 'bg-brown.light'
        }, {
    ...
    */
    onShareAppMessage: function () {
        return {
            ...
            imageUrl: 'https://kameee.top/upload/2020/05/gh_b9eb9671481c_344%20(1)-fa6427183c024225870a1f5ad1447670.jpg',
        }
    },
})
